...
public class Fila
{
    ...
    public String toString() {
        String toString = "";
        toString = String.format("Identificador ", id);
        toString = String.format("Fecha ", fecha);
        toString = String.format("\bIngresos ", ingresos);
        toString = String.format("Gastos ", gastos);
        return toString;
    }
